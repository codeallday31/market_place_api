...
class Api::V1::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product" do
    assert_difference("Product.count") do
      post api_v1_products_url,
        params: { product: { title: @product.title, price: @product.price, published: @product.published, quantity: 10 } },
  ...
  test "should forbid destroy product" do
    assert_no_difference("Product.count") do
      delete api_v1_product_url(@product),
        headers: { Authorization: JsonWebToken.encode(user_id: products(:two).id) }, as: :json
    end
    assert_response :forbidden
  end
end
